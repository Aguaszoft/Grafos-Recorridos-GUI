...
public class GrafoGUI {
    ...
    public GrafoGUI() {
        ...
        BFSButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int inicio = Integer.parseInt(txtVinicio.getText());
                    String bfsResultado = grafo.bfs(inicio);
                    txtResultado.append("BFS desde vértice " + inicio + ": " + bfsResultado + "\n");
                } catch (Exception ex) {
        ...
        DFSButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int startVertex = Integer.parseInt(txtVinicio.getText());
                    String dfsResultado = grafo.dfs(startVertex);
                    txtResultado.append("DFS desde vértice " + startVertex + ": " + dfsResultado + "\n");
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Por favor, ingrese un índice válido.");
                }
            }
